          ...
          <div className="bg-white p-6 w-full max-w-md lg:w-[470px]">
            ...
            <ul className="mb-4 space-y-4">
              <li className="flex items-center">
                <Image src="/led.svg" alt="LCD Monitor" width={48.88} height={42.22} />
              ...
              <li className="flex items-center">
                <Image src="/game.svg" alt="HI Gamepad" width={48.88} height={42.22} />
                <div className="flex justify-between w-full text-sm ml-4">
            ...
            <Image src="/kash.svg" alt="img1" width={39.2} height={25} />
            <Image src="/visa.svg" alt="img2" width={39.2} height={25} />
            <Image src="/mucard.svg" alt="img3" width={39.2} height={25} />
            <Image src="/hindi.svg" alt="img4" width={39.2} height={25} />
          </div>
        </div>
